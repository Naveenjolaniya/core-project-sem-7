...
public class DropServlet extends HttpServlet
{
	...
	throws ServletException, IOException
	{
		...
		bamt = request.getParameter("bamt");
		...
		{				
			...
			st.executeUpdate("delete bidding_info where bidderid = '" + uname + "' and itemid='" + itemid + "' and bamt = " + bamt);
			pw.println("<B>successfully dropped from the auction...</B><br>");
			pw.println("<center><input type=button value=Back onClick=history.back()><BR><hr>");
