...
public class RegistrationServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException
	{
		...
		try
		{
			...
			RegistrationHome home = (RegistrationHome)ctx.lookup("RegistrationHome");			
			Registration remote = (Registration)home.create(theuser, password, fname,lname,emailaddress,phno,address,city,state,pin,country,creditcard);
