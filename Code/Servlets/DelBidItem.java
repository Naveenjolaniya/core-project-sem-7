...
public class DelBidItem extends HttpServlet
{
PrintWriter pw;
	Connection con;
...
int mon=d.getMonth();
int year=d.getYear();
PreparedStatement pst=con.prepareStatement("delete from item_master where enddate < ?");
pst.setDate(1,new java.sql.Date(year,mon,d1));
