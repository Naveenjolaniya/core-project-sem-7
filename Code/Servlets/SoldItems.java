...
public class SoldItems extends HttpServlet
{
	...
	throws ServletException, IOException
	{
		...
		try
		{
			...
			pw.println("<center>");	
			rs = st.executeQuery("select itemid from item_master where sellerid='"+uname+"' minus select itemid from mailinfo where paid='YES'");
			if(rs.next())
			{
				String iid = rs.getString(1);
				pw.println("<h1>You sold</h1><br>");
				...
				pw.println("<h1>No recent sellings</h1>");
